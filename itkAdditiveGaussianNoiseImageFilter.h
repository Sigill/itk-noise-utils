...
public:
  ...
  double GetStandardDeviation() const { return m_StandardDeviation; }
...
public:
  ...
  double GetMean() const { return this->GetFunctor().GetMean(); }
  double GetStandardDeviation() const { return this->GetFunctor().GetStandardDeviation(); }
